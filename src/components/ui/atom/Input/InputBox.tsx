import { inputBoxRoundness, inputBoxSizes, inputBoxStyles } from "@src/constants/atom-components";
...
const selectRounded: Record<inputBoxRoundness, string> = {
  primary: "rounded-[2.5rem]",
  square: "rounded-[0.5rem]",
  keyboard: "rounded-none",
};

const sizeSelector: Record<inputBoxSizes, string> = {
  xsmall: "h-6 text-xs",
  small: "h-12",
  medium: "h-14",
  large: "h-16",
...
const styleSelector: Record<inputBoxStyles, string> = {
